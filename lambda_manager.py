...
@click.option("--list-lambda", is_flag=True, help="List all lambda functions over 1 year old")
...
@click.option("--year", default=2020, help="Delete old lambda functions earlier than year")
